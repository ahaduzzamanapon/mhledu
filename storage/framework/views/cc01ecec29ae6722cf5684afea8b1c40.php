        ...
        ">
            <a href='<?php echo e(route('frontend.course-details', $course->id)); ?>' class="course_item">
                <div class="course_item_img">
                    ...
                    <span
                        class="course_item_img_status <?php echo e($color); ?>"><?php echo e($course->courseCategory->category_name ?? 'mhledu'); ?>
...
<?php endif; ?>
<?php /**PATH F:\laragon\www\edu\resources\views/components/edulia/course.blade.php ENDPATH**/ ?>