        ...
        if($allData['Saas'] == TRUE){
            ...
            for($i=2; $i<=5; $i++){
                ...
                for ($role_id = 4; $role_id <10; $role_id++) {
                    ...
                    $newUser->email     = $First_Name . $j . '@mhledu.com';
                    $newUser->username  = $First_Name . $j . '@mhledu.com';
                ...
                for ($j = 1; $j <= 20; $j++) {
                                ...
                                $studentEmail = strtolower($student_User_Name) . $j . '@mhledu.com';
                                ...
                                $newUser->email     = strtolower($Father_User_Name).'_pa' . $j . '@mhledu.com';
                                $newUser->username  = strtolower($Father_User_Name).'_pa' . $j . '@mhledu.com';
                                $newUser->password  = Hash::make(123456);
                                ...
                                $parent->guardians_email      = $Guardian_First_Name . $j . '@mhledu.com';
