    ...
    public function run(): void
    {
        DB::table('sm_events')->insert([
            [
                ...
                Prepare for an electrifying event as mhledu proudly announces its upcoming Robotics Competition set to ignite the campus with technological brilliance and inventive spirit.
                Event Overview:
