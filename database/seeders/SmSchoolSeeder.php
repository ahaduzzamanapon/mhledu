...
class SmSchoolSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //                         User::factory()->times(1)->create([
        //                             'role_id' =>2,
        //                             'email'=>'student_'.$data->class_id.'_'.$data->section_id.'_'.$i.'@mhledu.com', 
        //                             'username'=>'student_'.$data->class_id.'_'.$data->section_id.'_'.$i.'@mhledu.com',
        //                             'school_id' =>$school->id,
        //                         ]);
        //                         User::factory()->times(1)->create([
        //                             'role_id' =>3,
        //                             'email'=>'guardian_'.$data->class_id.'_'.$data->section_id.'_'.$i.'@mhledu.com', 
        //                             'username'=>'guardian_'.$data->class_id.'_'.$data->section_id.'_'.$i.'@mhledu.com',
        //                             'school_id' =>$school->id,
        //                         ]);
        ...
        //                 $sql[] = ['theme_id'  => $theme->id, 'color_id' => 2, 'value'  => "#3091ff"];
        //                 $sql[] = ['theme_id'  => $theme->id, 'color_id' => 3, 'value'  => "#c738d8"];
        //                 $sql[] = ['theme_id'  => $theme->id, 'color_id' => 4, 'value'  => "#3091ff"];
        ...
        //             [
        //                 'url' => 'https://www.facebook.com/mhl',
        //                 'icon' => 'fa fa-facebook',
        //                 'status' => 1,
        //                 'school_id' => $school->id,
        //             ],
        ...
        //         $s->link_href1  = 'http://mhledu.com';
        
        //         $s->link_label2 = 'Infix Home';
        //         $s->link_href2  = 'http://mhledu.com/home';
        
        //         $s->link_label3 = 'Business';
        //         $s->link_href3  = 'http://mhledu.com';
        
        //         $s->link_label4 = 'link_label4';
        //         $s->link_href4  = 'http://mhledu.com';
        
        //         $s->link_label5 = 'link_label5';
        //         $s->link_href5  = 'http://mhledu.com';
        
        //         $s->link_label6 = 'link_label6';
        //         $s->link_href6  = 'http://mhledu.com';
        
        //         $s->link_label7 = 'link_label7';
        //         $s->link_href7  = 'http://mhledu.com';
        
        //         $s->link_label8 = 'link_label8';
        //         $s->link_href8  = 'http://mhledu.com';
        
        //         $s->link_label9  = 'Home';
        //         $s->link_href9   = 'http://mhledu.com/home';
        
        //         $s->link_label10 = 'About';
        //         $s->link_href10  = 'http://mhledu.com/about';
        
        
        //         $s->link_label11 = 'Contact';
        //         $s->link_href11  = 'http://mhledu.com/contact';
        
        //         $s->link_label12 = 'link_label12';
        //         $s->link_href12  = 'http://mhledu.com';
        
        //         $s->link_label13 = 'link_label13';
        //         $s->link_href13  = 'http://mhledu.com';
        
        //         $s->link_label14 = 'link_label14';
        //         $s->link_href14  = 'http://mhledu.com';
        
        //         $s->link_label15 = 'link_label15';
        //         $s->link_href15  = 'http://mhledu.com';
        
        //         $s->link_label16 = 'link_label16';
        //         $s->link_href16  = 'http://mhledu.com';
        //         $s->school_id = $school->id; 
        //         $s->save();
