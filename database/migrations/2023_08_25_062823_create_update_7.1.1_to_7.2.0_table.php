...
return new class extends Migration
{
    public function up()
    {
        ...
        $s2->email = 'support@mhl.com';
        $s2->notes = "This is Behaviour Records Module for manage student behaviour records & Activity. Thanks for using .";
        $s2->version = "1.0";
        $s2->update_url = "https://mhl.com/contact";
        $s2->is_default = 0;
        $s2->purchase_code = time();
        $s2->addon_url = "https://codecanyon.net/item/google-meet-module-for-mhledu-gmeet-live-class/42463761";
            ...
            <tbody>
                <tr style="vertical-align:top;" valign="top">
                    <td style="vertical-align:top;" valign="top">
                        ...
                        <div style="background-color:#3091ff;">
                            <div class="block-grid"
