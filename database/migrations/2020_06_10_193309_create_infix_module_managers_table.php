...
class CreateInfixModuleManagersTable extends Migration
{
    ...
    public function up()
    {
        ...
        try {
            ...
            $s->version = "1.0";
            $s->update_url = "https://mhl.com/contact";
            $s->is_default = 0;
            $s->addon_url = "https://codecanyon.net/item/mhledu-zoom-live-class/27623128?s_rank=12";
            $s->installed_domain = url('/');
            $s->activated_date = date('Y-m-d');
            $s->save();
            ...
            $s->update_url = "https://mhl.com/contact";
            $s->is_default = 0;
            $s->addon_url = "mailto:support@mhl.com";
            $s->installed_domain = url('/');
            $s->activated_date = date('Y-m-d');
            $s->save();
            ...
            $s->update_url = "https://mhl.com/contact";
            $s->is_default = 0;
            $s->addon_url = "https://codecanyon.net/item/razorpay-payment-gateway-for-mhledu/27721206?s_rank=11";
            $s->installed_domain = url('/');
            $s->activated_date = date('Y-m-d');
            $s->save();
            ...
            $bulk_print->email = 'support@mhl.com';
            ...
            $bulk_print->update_url = "https://mhl.com/contact";
            $bulk_print->is_default = 1;
            $bulk_print->addon_url = "https://codecanyon.net/item/mhledu-zoom-live-class/27623128?s_rank=12";
            ...
            $XenditPayment->email = 'support@mhl.com';
            ...
            $XenditPayment->update_url = "https://mhl.com/contact";
            $XenditPayment->is_default = 1;
            $XenditPayment->addon_url = "mailto:support@mhl.com";
            ...
            $s->save();
             ...
             $s->update_url = "https://mhl.com/contact";
             $s->is_default = 0;
             $s->addon_url = "https://codecanyon.net/item/google-meet-module-for-mhledu-gmeet-live-class/42463761";
             $s->installed_domain = url('/');
             $s->activated_date = date('Y-m-d');
             $s->save();
             ...
             $s->update_url = "https://mhl.com/contact";
             $s->is_default = 0;
             $s->addon_url = "https://mhl.com/contact";
             $s->installed_domain = url('/');
             $s->activated_date = date('Y-m-d');
             $s->save();
            ...
            $s->name = "CcAveune";
            $s->email = 'support@mhl.com';
            $s->notes = "This CcAveune Module For mhledu . Manage online payment for fees & wallet.";
            $s->version = "1.0";
            $s->update_url = "https://mhl.com/contact";
            $s->is_default = 0;
            $s->addon_url = "maito:support@mhl.com";
            $s->installed_domain = url('/');
            $s->activated_date = date('Y-m-d');
            $s->save();
        ...
        // Certificate
            ...
            $s->is_default = 0;
            $s->version = '1.0' ;
            $s->update_url = "maito:support@mhl.com";
            $s->purchase_code = null;
            $s->installed_domain = null;
            $s->activated_date = null;
            $s->save();
            ...
            $s->email = 'support@mhl.com';
            $s->notes = "This InAppLiveClass Module For mhledu . Manage Online Class and Meeting Reports.";
            $s->version = "1.0";
            $s->update_url = "https://mhl.com/contact";
            $s->is_default = 0;
            $s->addon_url = "maito:support@mhl.com";
