...
[ {
  ...
  "downloadUrl" : "http://mhledu.com",
  "operatingSystem" : "2019",
  "requirements" : "in a complete",
  "screenshot" : "http://mhledu.com/public/landing/img/dashboard_preview.png",
  "softwareVersion" : "2.0",
  ...
  "review" : {
    ...
    "reviewBody" : "Query\n                                Account"
        ...
        <meta name="twitter:site" content="@mhledu"/>
        <meta name="twitter:creator" content="@mhledu"/>
        ...
        <meta property="og:image" content="http://mhledu.com/public/landing/img/dashboard_preview.png"/>


        <!-- Open Graph data -->
        <meta property="og:type" content="website" />
        <meta property="og:url" content="//mhledu.com/"/>
        <meta property="og:image" content="//mhledu.com/public/landing/img/dashboard_preview.png"/>
    ...
    <link rel="canonical" href="http://mhledu.com" hreflang="en-us" />
...
<body>
                ...
                <div class="col-lg-6 col-xl-5">
                    <div class="banner_text">
                        <div class="banner_text_iner">
                            ...
                            <a  class="btn_1" target="_blank" href="mailto:support@mhl.com?subject=Request for saas school demo!&body=This is only a test!"> <i class="ti-email"></i> For Saas Demo</a>
                            @endif
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <!-- <a class="btn_1 d-none d-lg-block" target="_blank" href="http://salespanel.mhledu.com/">Purchase</a> -->
    ...
    <section class="contact_us padding_top" id="Support">
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-6">
                    <a href="https://ticket.mhl.com/help-center" target="_blank">
                        <div class="single_feature">
                            <div class="single_feature_part">
                ...
                <div class="col-md-6">
                    <a class="support-link" target="_blank" href="https://ticket.aorasoft.com/mhledu">
                        <div class="single_feature">
                            <div class="single_feature_part">
                                <span class="single_feature_icon"><i class="ti-write"></i></span>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="footer_area_text">
                        ...
                        <!-- <a href="http://salespanel.mhledu.com/" class="footer_btn"> <i class="ti-shopping-cart-full"></i> -->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="copyright_text"> 
                        <p> <img src="{{asset('public/landing/img/copyright.svg')}}" alt="#"> 2019-2020 mhledu - Ultimate Education ERP. All Rights
    ...
    <!-- footer part end--> 
<!--    <div class="skype-button bubble" data-bot-id="mhl"> </div>
