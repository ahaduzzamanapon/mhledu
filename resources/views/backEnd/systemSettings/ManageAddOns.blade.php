...
@push('script')
    <script type="text/javascript" src="{{ asset('public/vendor/mhl/js/parsley.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('public/vendor/mhl/js/function.js') }}"></script>
    <script type="text/javascript" src="{{ asset('public/vendor/mhl/js/common.js') }}"></script>
@endpush

@section('mainContent')
    <link rel="stylesheet" href="{{ asset('public/vendor/mhl/css/parsley.css') }}">
    <style type="text/css">
        #selectStaffsDiv,
        .forStudentWrapper {
            display: none;
